...
npm是一種套件管理的工具，用來管理專案下所使用的套件與開發環境上所使用的工具，通常裝Node時就會一併被安裝.
...
> 以上gulp-demo的設定僅供參考，因為現在本身已比較常用 Angular cli 作為開發環境，擔心會有遺漏的地方，如有錯誤或建言，歡迎在[issues](https://github.com/JiaHongL/gulp-demo/issues) 提出，感謝.
